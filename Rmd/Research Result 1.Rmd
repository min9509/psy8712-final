...
print(gender_female)
print(gender_male)
print(marital_single)
print(marital_married)
print(marital_div_wid)
print(permanent_p)
print(permanent_t)
```
...
## (2) Correlation
```{r analysis}
cor.test(Wave2_tbl$job_satis, Wave2_tbl$clan_culture)
```
...
print(skew_job_satis)
print(kurt_job_satis)
print(skews_clan_culture)
print(kurt_clan_culture)
```
